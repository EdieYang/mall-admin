  ...
  <d2-container>
    ...
    <template>
      <el-table :data="data" style="width: 100%;" border>
        ...
        <el-table-column label="待结算订单数量" align="center" width="130" prop="settleOrderNums">
          <template slot-scope="scope">
            <span>{{ scope.row.settleOrderNums }}</span>
          </template>
        </el-table-column>

        <el-table-column label="待结算金额（元）" align="center" width="180" prop="settleAmount">
          <template slot-scope="scope">
        ...
        <el-table-column label="创建时间" align="center" width="180" prop="shopStatus">
          <template slot-scope="scope">
        ...
        <el-table-column label="操作" align="center" width="180" fixed="right">
          <template slot-scope="scope">
            <el-tooltip content="扫码绑定管理员" placement="top-start" effect="light">
              <el-button type="warning" icon="el-icon-data-line" circle @click="run(scope.row.shopId,'1')"></el-button>
            </el-tooltip>
            <el-tooltip content="管理员" placement="top-start" circle effect="light">
              <el-button type="success" icon="el-icon-user" circle @click="toShopSysUser(scope.row.shopId)"></el-button>
            </el-tooltip>
...
export default {
  ...
  methods: {
    ...
    toShopSysUser(shopId) {
      this.$router.push({ path: '/shop/shopSysUser/shopIndex', query: { shopId: shopId } });
    },

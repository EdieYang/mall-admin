    ...
    <div style="width:100%;">
      <el-card v-loading="pageLoading">
        ...
        >
          ...
          <el-form-item label="商家所在市区" prop="addressDistrict">
            <el-select
          ...
          <el-form-item label="商家地址" prop="addressDetail">
            <el-input
              type="text"
          ...
          <el-form-item label="状态" prop="shopStatus">
            <el-radio-group v-model="form.shopStatus" size="small">
              <el-radio label="0" border>停运</el-radio>
          ...
          <el-form-item>
            <el-button type="primary" @click="shopNew" size="small"
              >提 交</el-button
            >
          </el-form-item>
        </el-form>
...
export default {
  ...
  methods: {
    ...
    shopNew() {
      this.$refs.form.validate(valid => {
        if (valid) {
          ...
          debugger
          if (
            formData.openTime[0] instanceof Date ||
            formData.openTime[1] instanceof Date
          ) {
            let startTime =
              this.form.openTime[0].getHours() < 10
                ? '0' + this.form.openTime[0].getHours()
                : this.form.openTime[0].getHours()
            startTime += ':'
            startTime +=
              this.form.openTime[0].getMinutes() < 10
                ? '0' + this.form.openTime[0].getMinutes()
                : this.form.openTime[0].getMinutes()
            let endTime =
              this.form.openTime[1].getHours() < 10
                ? '0' + this.form.openTime[1].getHours()
                : this.form.openTime[1].getHours()
            endTime += ':'
            endTime +=
              this.form.openTime[1].getMinutes() < 10
                ? '0' + this.form.openTime[1].getMinutes()
                : this.form.openTime[1].getMinutes()
    ...
    handleSuccess(response, file, fileList) {
      ...
      this.canUpload = true
      let picFile = {
        imgName: file.response.data.split('/')[

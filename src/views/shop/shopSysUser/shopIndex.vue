<template>
  <d2-container>
    <template slot="header">
      ...
      <el-button type="primary" size="small" round="" icon="el-icon-folder-add" @click="newShopSysUser()">添加商家管理员</el-button>
      <el-button type="primary" size="small" round="" icon="el-icon-folder-add" @click="consumeList()">查看核销记录</el-button>
    ...
    <template>
      ...
      <el-dialog :title="dialogTitle" :visible.sync="shopSysUserDialog" width="30%" center>
        <el-form :model="form" :rules="rules" ref="form" label-width="100px" class="dialogForm">
        ...
        <span slot="footer" class="dialog-footer">
          <el-button @click="shopSysUserDialog = false;form.userAcc='';form.realName=''">取 消</el-button>

  ...
  <d2-container>
    <template slot="header">
      <div class="header-cover">
        ...
        <el-button type="primary"
                   ...
                   @click="newShopBusinessArea">新增商圈</el-button>
    ...
    <template>
          ...
          <template slot-scope="scope">
            ...
            <el-tooltip content="编辑商铺"
              ...
              <el-button type="primary"
                         icon="el-icon-edit"
                         circle
                         @click="editShopBusinessArea(scope.row.id,scope.row.areaName)"></el-button>
            </el-tooltip>
            ...
            <el-tooltip content="删除"
              ...
              <el-button type="danger"
                         icon="el-icon-delete"
                         circle
                         @click="delShopBusinessArea(scope.row.id)"></el-button>
            </el-tooltip>
          </template>
        </el-table-column>
      </el-table>
      ...
      <el-dialog :title="dialogTitle"
        ...
        <span slot="footer"
              class="dialog-footer">
          <el-button @click="shopBusinessAreaDialog = false;form.areaName=''">取 消</el-button>
          <el-button type="primary"
                     @click="editArea()"
                     v-if="businessAreaId!=''">提 交</el-button>
          <el-button type="primary"
                     @click="newArea()"
                     v-if="businessAreaId==''">提 交</el-button>
        </span>
...
<script>
import { businessAreaList, businessAreaEdit, businessAreaNew } from "@/api/shop/businessAreaApi"

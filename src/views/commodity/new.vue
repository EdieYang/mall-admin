      ...
      <el-card v-loading="pageLoading">
        <el-form ref="form" :model="form" label-width="90px" label-position="left" :rules="formRules" style="width:640px;display: inline-block;">
          ...
          <el-form-item label="商户Id" prop="shopId">
            <el-input v-model="form.shopId" placeholder="请输入商户Id" disabled></el-input>
          </el-form-item>
          ...
          <el-form-item label="手机" prop="mobile">
            <el-input v-model="form.mobile" placeholder="请输入手机" :maxlength="11"></el-input>
          </el-form-item>
          <el-form-item label="微信" prop="wechat">
            <el-input v-model="form.wechat" placeholder="请输入微信"></el-input>
          </el-form-item>
          <el-form-item label="所在地" prop="addressDistrict">
            <el-select v-model="form.addressDistrict" placeholder="请选择所在地（仅限上海市）" value="" style="width:100%;">
          ...
          <el-form-item>
            <el-button  type="primary" @click="shopNew" size="small">提 交</el-button>
          </el-form-item>
        </el-form>
      </el-card>
    </div>

  ...
  <d2-container>
    ...
    <el-row>
      <el-col :span="8" style="margin-top:15px;">
        <el-tree ref="tree" class="filter-tree" node-key="id" default-expand-all highlight-current :expand-on-click-node="false" :data="menuList" :props="defaultProps" @node-click="getMenuData"></el-tree>
      </el-col>
      <el-col :span="16" style="margin-top:15px;">
        <el-card shadow="always">
          <el-form label-position="right" label-width="80px" :model="menuform" :rules="formRules" ref="menuform">
            ...
            <el-form-item label="排序" prop="sort">
              <el-input v-model="menuform.sort" :disabled="!formEdit" type="number" step="1" placeholder="请输入排序"></el-input>
            </el-form-item>
